...
const Widget_Display3=() => {
    ...
    const style1 = {
      ...
      const AddSecond = () => {
        setItems(arr_to_map.concat({ id: lenght + 1, name: <img style={style1} src={require('./Images/Widget_3.png')}/> }));
      };
          ...
          <ul>
            <li>
              <div className='one_three'>
                <img style={style1}  src={require('./Images/Widget_3.png')} />
              </div>
            </li>
...
export default Widget_Display3;
